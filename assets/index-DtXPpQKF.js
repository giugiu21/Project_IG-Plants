...
void main() {
	...
	`}function Rm(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Vo||l===ko,u=l===Ui||l===Fi;if(c||u){let h=t.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new Nl(i)),h=c?e.fromEquirectangular(a,h):e.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),h.texture;if(h!==void 0)return h.texture;{const d=a.image;return c&&d&&d.height>0||u&&d&&r(d)?(e===null&&(e=new Nl(i)),h=c?e.fromEquirectangular(a):e.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function Cm(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Pm(i,t,e,n){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)t.remove(_[p])}f.removeEventListener("dispose",o),delete r[f.id];const d=s.get(f);d&&(t.remove(d),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,e.memory.geometries++),f}function l(h){const f=h.attributes;for(const g in f)t.update(f[g],i.ARRAY_BUFFER);const d=h.morphAttributes;for(const g in d){const _=d[g];for(let p=0,m=_.length;p<m;p++)t.update(_[p],i.ARRAY_BUFFER)}}function c(h){const f=[],d=h.index,g=h.attributes.position;let _=0;if(d!==null){const S=d.array;_=d.version;for(let M=0,w=S.length;M<w;M+=3){const L=S[M+0],R=S[M+1],A=S[M+2];f.push(L,R,R,A,A,L)}}else if(g!==void 0){const S=g.array;_=g.version;for(let M=0,w=S.length/3-1;M<w;M+=3){const L=M+0,R=M+1,A=M+2;f.push(L,R,R,A,A,L)}}else return;const p=new(nu(f)?lu:au)(f,1);p.version=_;const m=s.get(h);m&&t.remove(m),s.set(h,p)}function u(h){const f=s.get(h);if(f){const d=h.index;d!==null&&f.version<d.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function Lm(i,t,e){let n;function r(f){n=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function l(f,d){i.drawElements(n,d,s,f*o),e.update(d,n,1)}function c(f,d,g){g!==0&&(i.drawElementsInstanced(n,d,s,f*o,g),e.update(d,n,g))}function u(f,d,g){if(g===0)return;const _=t.get("WEBGL_multi_draw");if(_===null)for(let p=0;p<g;p++)this.render(f[p]/o,d[p]);else{_.multiDrawElementsWEBGL(n,d,0,s,f,0,g);let p=0;for(let m=0;m<g;m++)p+=d[m];e.update(p,n,1)}}function h(f,d,g,_){if(g===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<f.length;m++)c(f[m]/o,d[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,d,0,s,f,0,_,0,g);let m=0;for(let S=0;S<g;S++)m+=d[S];for(let S=0;S<_.length;S++)e.update(m,n,_[S])}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Dm(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(s/3);break;case i.LINES:e.lines+=a*(s/2);break;case i.LINE_STRIP:e.lines+=a*(s-1);break;case i.LINE_LOOP:e.lines+=a*s;break;case i.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function Im(i,t,e){const n=new WeakMap,r=new se;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(a);if(f===void 0||f.count!==h){let v=function(){U.dispose(),n.delete(a),a.removeEventListener("dispose",v)};var d=v;f!==void 0&&f.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],S=a.morphAttributes.normal||[],M=a.morphAttributes.color||[];let w=0;g===!0&&(w=1),_===!0&&(w=2),p===!0&&(w=3);let L=a.attributes.position.count*w,R=1;L>t.maxTextureSize&&(R=Math.ceil(L/t.maxTextureSize),L=t.maxTextureSize);const A=new Float32Array(L*R*4*h),U=new su(A,L,R,h);U.type=Rn,U.needsUpdate=!0;const y=w*4;for(let D=0;D<h;D++){const F=m[D],P=S[D],k=M[D],X=L*R*4*D;for(let Z=0;Z<F.count;Z++){const et=Z*y;g===!0&&(r.fromBufferAttribute(F,Z),A[X+et+0]=r.x,A[X+et+1]=r.y,A[X+et+2]=r.z,A[X+et+3]=0),_===!0&&(r.fromBufferAttribute(P,Z),A[X+et+4]=r.x,A[X+et+5]=r.y,A[X+et+6]=r.z,A[X+et+7]=0),p===!0&&(r.fromBufferAttribute(k,Z),A[X+et+8]=r.x,A[X+et+9]=r.y,A[X+et+10]=r.z,A[X+et+11]=k.itemSize===4?r.w:1)}}f={count:h,texture:U,size:new Q(L,R)},n.set(a,f),a.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const _=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:s}}function Nm(i,t,e,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=t.get(l,u);if(r.get(h)!==c&&(t.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==c&&(f.update(),r.set(f,c))}return h}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:o}}class pu extends Ae{constructor(t,e,n,r,s,o,a,l,c,u){if(u=u!==void 0?u:Ii,u!==Ii&&u!==lr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ii&&(n=zi),n===void 0&&u===lr&&(n=pr),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:Ve,this.minFilter=l!==void 0?l:Ve,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const mu=new Ae,gu=new pu(1,1);gu.compareFunction=eu;const _u=new su,vu=new Mf,xu=new hu,zl=[],Bl=[],Hl=new Float32Array(16),Vl=new Float32Array(9),kl=new Float32Array(4);function Vi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=zl[r];if(s===void 0&&(s=new Float32Array(r),zl[r]=s),t!==0){n.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(s,a)}return s}function pe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function me(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Ls(i,t){let e=Bl[t];e===void 0&&(e=new Int32Array(t),Bl[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Um(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Fm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(pe(e,t))return;i.uniform2fv(this.addr,t),me(e,t)}}function Om(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(pe(e,t))return;i.uniform3fv(this.addr,t),me(e,t)}}function zm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(pe(e,t))return;i.uniform4fv(this.addr,t),me(e,t)}}function Bm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(pe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),me(e,t)}else{if(pe(e,n))return;kl.set(n),i.uniformMatrix2fv(this.addr,!1,kl),me(e,n)}}function Hm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(pe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),me(e,t)}else{if(pe(e,n))return;Vl.set(n),i.uniformMatrix3fv(this.addr,!1,Vl),me(e,n)}}function Vm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(pe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),me(e,t)}else{if(pe(e,n))return;Hl.set(n),i.uniformMatrix4fv(this.addr,!1,Hl),me(e,n)}}function km(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Gm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(pe(e,t))return;i.uniform2iv(this.addr,t),me(e,t)}}function Wm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(pe(e,t))return;i.uniform3iv(this.addr,t),me(e,t)}}function Xm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(pe(e,t))return;i.uniform4iv(this.addr,t),me(e,t)}}function Ym(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function qm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(pe(e,t))return;i.uniform2uiv(this.addr,t),me(e,t)}}function Zm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(pe(e,t))return;i.uniform3uiv(this.addr,t),me(e,t)}}function jm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(pe(e,t))return;i.uniform4uiv(this.addr,t),me(e,t)}}function Km(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?gu:mu;e.setTexture2D(t||s,r)}function Jm(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||vu,r)}function $m(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||xu,r)}function Qm(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||_u,r)}function t0(i){switch(i){case 5126:return Um;case 35664:return Fm;case 35665:return Om;case 35666:return zm;case 35674:return Bm;case 35675:return Hm;case 35676:return Vm;case 5124:case 35670:return km;case 35667:case 35671:return Gm;case 35668:case 35672:return Wm;case 35669:case 35673:return Xm;case 5125:return Ym;case 36294:return qm;case 36295:return Zm;case 36296:return jm;case 35678:case 36198:case 36298:case 36306:case 35682:return Km;case 35679:case 36299:case 36307:return Jm;case 35680:case 36300:case 36308:case 36293:return $m;case 36289:case 36303:case 36311:case 36292:return Qm}}function e0(i,t){i.uniform1fv(this.addr,t)}function n0(i,t){const e=Vi(t,this.size,2);i.uniform2fv(this.addr,e)}function i0(i,t){const e=Vi(t,this.size,3);i.uniform3fv(this.addr,e)}function r0(i,t){const e=Vi(t,this.size,4);i.uniform4fv(this.addr,e)}function s0(i,t){const e=Vi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function o0(i,t){const e=Vi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function a0(i,t){const e=Vi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function l0(i,t){i.uniform1iv(this.addr,t)}function c0(i,t){i.uniform2iv(this.addr,t)}function u0(i,t){i.uniform3iv(this.addr,t)}function h0(i,t){i.uniform4iv(this.addr,t)}function f0(i,t){i.uniform1uiv(this.addr,t)}function d0(i,t){i.uniform2uiv(this.addr,t)}function p0(i,t){i.uniform3uiv(this.addr,t)}function m0(i,t){i.uniform4uiv(this.addr,t)}function g0(i,t,e){const n=this.cache,r=t.length,s=Ls(e,r);pe(n,s)||(i.uniform1iv(this.addr,s),me(n,s));for(let o=0;o!==r;++o)e.setTexture2D(t[o]||mu,s[o])}function _0(i,t,e){const n=this.cache,r=t.length,s=Ls(e,r);pe(n,s)||(i.uniform1iv(this.addr,s),me(n,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||vu,s[o])}function v0(i,t,e){const n=this.cache,r=t.length,s=Ls(e,r);pe(n,s)||(i.uniform1iv(this.addr,s),me(n,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||xu,s[o])}function x0(i,t,e){const n=this.cache,r=t.length,s=Ls(e,r);pe(n,s)||(i.uniform1iv(this.addr,s),me(n,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||_u,s[o])}function M0(i){switch(i){case 5126:return e0;case 35664:return n0;case 35665:return i0;case 35666:return r0;case 35674:return s0;case 35675:return o0;case 35676:return a0;case 5124:case 35670:return l0;case 35667:case 35671:return c0;case 35668:case 35672:return u0;case 35669:case 35673:return h0;case 5125:return f0;case 36294:return d0;case 36295:return p0;case 36296:return m0;case 35678:case 36198:case 36298:case 36306:case 35682:return g0;case 35679:case 36299:case 36307:return _0;case 35680:case 36300:case 36308:case 36293:return v0;case 36289:case 36303:case 36311:case 36292:return x0}}class y0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=t0(e.type)}}class S0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=M0(e.type)}}class E0{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],n)}}}const go=/(\w+)(\])?(\[|\.)?/g;function Gl(i,t){i.seq.push(t),i.map[t.id]=t}function w0(i,t,e){const n=i.name,r=n.length;for(go.lastIndex=0;;){const s=go.exec(n),o=go.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Gl(e,c===void 0?new y0(a,i,t):new S0(a,i,t));break}else{let h=e.map[a];h===void 0&&(h=new E0(a),Gl(e,h)),e=h}}}class ds{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),o=t.getUniformLocation(e,s.name);w0(s,o,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&n.push(o)}return n}}function Wl(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const b0=37297;let T0=0;function A0(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function R0(i){const t=Jt.getPrimaries(Jt.workingColorSpace),e=Jt.getPrimaries(i);let n;switch(t===e?n="":t===_s&&e===gs?n="LinearDisplayP3ToLinearSRGB":t===gs&&e===_s&&(n="LinearSRGBToLinearDisplayP3"),i){case Nn:case Cs:return[n,"LinearTransferOETF"];case ye:case la:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Xl(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+A0(i.getShaderSource(t),o)}else return r}function C0(i,t){const e=R0(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function P0(i,t){let e;switch(t){case wh:e="Linear";break;case bh:e="Reinhard";break;case Th:e="OptimizedCineon";break;case Xc:e="ACESFilmic";break;case Rh:e="AgX";break;case Ch:e="Neutral";break;case Ah:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function L0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(er).join(`
`)}function D0(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function I0(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function er(i){return i!==""}function Yl(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function ql(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const N0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Xo(i){return i.replace(N0,F0)}const U0=new Map;function F0(i,t){let e=Lt[t];if(e===void 0){const n=U0.get(t);if(n!==void 0)e=Lt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Xo(e)}const O0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Zl(i){return i.replace(O0,z0)}function z0(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function jl(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function B0(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===kc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Gc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===fn&&(t="SHADOWMAP_TYPE_VSM"),t}function H0(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ui:case Fi:t="ENVMAP_TYPE_CUBE";break;case As:t="ENVMAP_TYPE_CUBE_UV";break}return t}function V0(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Fi:t="ENVMAP_MODE_REFRACTION";break}return t}function k0(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Wc:t="ENVMAP_BLENDING_MULTIPLY";break;case Sh:t="ENVMAP_BLENDING_MIX";break;case Eh:t="ENVMAP_BLENDING_ADD";break}return t}function G0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function W0(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=B0(e),c=H0(e),u=V0(e),h=k0(e),f=G0(e),d=L0(e),g=D0(s),_=r.createProgram();let p,m,S=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `}),h=new Xt(e,u);return h.frustumCulled=!1,h.castShadow=!1,h.receiveShadow=!0,h}function S_(i,t,e=null){i.material.uniforms.uTime.value=t,e&&i.material.uniforms.uCursorPosition.value.copy(e)}function E_(i=256){const t=document.createElement("canvas");t.width=i,t.height=i;const e=t.getContext("2d"),n=e.createRadialGradient(i/2,i/2,0,i/2,i/2,i/2);n.addColorStop(0,"rgba(255, 245, 190, 0.45)"),n.addColorStop(.35,"rgba(255, 230, 150, 0.18)"),n.addColorStop(1,"rgba(255, 220, 120, 0.0)"),e.fillStyle=n,e.fillRect(0,0,i,i);const r=new da(t);return r.colorSpace=ye,r}function w_(){const i=new Qt,t=new Ea(16770216,1.7);t.position.set(-3,6,3),t.target.position.set(0,0,0),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,t.shadow.camera.left=-8,t.shadow.camera.right=8,t.shadow.camera.top=8,t.shadow.camera.bottom=-8,t.shadow.camera.near=.5,t.shadow.camera.far=20,i.add(t),i.add(t.target);const e=E_(),n=new vr({map:e,transparent:!0,opacity:.32,depthWrite:!1,blending:Ke,side:Me}),r=new yr(1.6,5.5,7.5,64,1,!0),s=new Xt(r,n);return s.position.set(0,3.6,0),s.rotation.z=0,s.rotation.x=0,i.add(s),{group:i,sunlight:t,beam:s}}function b_(i,t){var r,s,o,a;const{sunlight:e,beam:n}=i;t?(e.color.set(9415423),e.intensity=.35,n.material.opacity=.08,(s=(r=n.material.color)==null?void 0:r.set)==null||s.call(r,10205439)):(e.color.set(16770216),e.intensity=1.7,n.material.opacity=.38,(a=(o=n.material.color)==null?void 0:o.set)==null||a.call(o,16777215))}function T_({count:i=350}={}){const t=new ne,e=new Float32Array(i*3);for(let s=0;s<i;s++){const o=Math.sqrt(Math.random())*4.8,a=Math.random()*Math.PI*2;e[s*3+0]=Math.cos(a)*o,e[s*3+1]=.35+Math.random()*3.2,e[s*3+2]=Math.sin(a)*o}t.setAttribute("position",new De(e,3));const n=new yu({color:15721921,size:.025,transparent:!0,opacity:.35,depthWrite:!1,blending:Ke}),r=new bg(t,n);return r.userData.initialPositions=e.slice(),r}function A_(i,t,e){const n=i.geometry.attributes.position.array,r=i.userData.initialPositions;for(let s=0;s<n.length/3;s++){const o=s*3;n[o+0]=r[o+0]+Math.sin(t*.35+s*.17)*.035,n[o+1]=r[o+1]+Math.sin(t*.55+s*.31)*.045,n[o+2]=r[o+2]+Math.cos(t*.28+s*.13)*.035}i.geometry.attributes.position.needsUpdate=!0,i.material.opacity=e?.12:.45}const Ao=new T,Ro=new T,rs=new T,tr=new T;function R_(i=128){const t=document.createElement("canvas");t.width=i,t.height=i;const e=t.getContext("2d"),n=e.createRadialGradient(i/2,i/2,0,i/2,i/2,i/2);n.addColorStop(0,"rgba(255, 255, 220, 1)"),n.addColorStop(.2,"rgba(255, 245, 170, 0.9)"),n.addColorStop(.45,"rgba(255, 220, 100, 0.35)"),n.addColorStop(1,"rgba(255, 200, 50, 0)"),e.fillStyle=n,e.fillRect(0,0,i,i);const r=new da(t);return r.colorSpace=ye,r}function C_(i,t=12){const e=new Qt,n=new Xt(new gn(.025,10,10),new vr({color:16775080,transparent:!0,opacity:1}));e.add(n);const r=new Yo(new Ms({map:i,color:16773544,transparent:!0,opacity:.85,depthWrite:!1,blending:Ke}));r.scale.set(.35,.35,.35),e.add(r);const s=new Sa(16770688,2.4,3,1.5);s.castShadow=!1,e.add(s);const o=new Float32Array(t*3),a=new ne;a.setAttribute("position",new De(o,3));const l=new Mr({color:16772761,transparent:!0,opacity:.18,blending:Ke,depthWrite:!1}),c=new Ds(a,l);e.add(c);const u=1.2+Math.random()*3.1,h=Math.random()*Math.PI*2,f=.35+Math.random()*1.5,d=Math.cos(h)*u,g=Math.sin(h)*u,_=f;e.position.set(d,_,g);for(let p=0;p<t;p++)o[p*3+0]=d,o[p*3+1]=_,o[p*3+2]=g;return e.userData={body:n,glow:r,light:s,trail:c,trailPositions:o,trailLength:t,baseRadius:u,baseHeight:f,theta:Math.random()*Math.PI*2,angularSpeed:.12+Math.random()*.25,wobbleSpeedX:.7+Math.random()*1,wobbleSpeedY:1+Math.random()*1.4,wobbleSpeedZ:.8+Math.random()*1,wobbleAmpX:.15+Math.random()*.22,wobbleAmpY:.12+Math.random()*.28,wobbleAmpZ:.15+Math.random()*.22,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:1.5+Math.random()*1.8,visibleStrength:0},e}function P_(i){let t=i;for(;t;){if(!t.visible)return!1;t=t.parent}return!0}function L_(i){if(!i.geometry)return .25;i.geometry.boundingSphere||i.geometry.computeBoundingSphere();const t=i.geometry.boundingSphere;i.getWorldScale(rs);const e=Math.max(rs.x,rs.y,rs.z);return t.radius*e+.18}function D_(i,t=[]){if(!(!t||t.length===0))for(const e of t){if(!e||!P_(e))continue;e.getWorldPosition(Ro);const n=L_(e),r=i.distanceTo(Ro);if(r<n){tr.subVectors(i,Ro),tr.lengthSq()<1e-4&&tr.set(Math.random()-.5,Math.random()*.45,Math.random()-.5),tr.normalize();const s=n-r;i.addScaledVector(tr,s*.78)}}}function I_({count:i=10,trailLength:t=12}={}){const e=new Qt,n=R_(),r=[],s=[];for(let o=0;o<i;o++){const a=C_(n,t);r.push(a),s.push(a.userData.light),e.add(a)}return e.userData.fireflies=r,e.userData.lights=s,{group:e,fireflies:r,lights:s,glowTexture:n}}function N_(i,t,e,n=[]){const{fireflies:r}=i;for(const s of r){const o=s.userData;o.visibleStrength=e?1:0,o.theta+=o.angularSpeed*.01;const a=Math.cos(o.theta)*o.baseRadius,l=Math.sin(o.theta)*o.baseRadius,c=Math.sin(t*o.wobbleSpeedX+o.pulsePhase)*o.wobbleAmpX,u=Math.sin(t*o.wobbleSpeedY+o.pulsePhase*1.3)*o.wobbleAmpY,h=Math.cos(t*o.wobbleSpeedZ+o.pulsePhase*.8)*o.wobbleAmpZ,f=a+c,d=Math.max(.18,o.baseHeight+u),g=l+h;Ao.set(f,d,g),e&&D_(Ao,n),s.position.copy(Ao);const _=.55+.45*Math.sin(t*o.pulseSpeed+o.pulsePhase),p=o.visibleStrength*_;o.body.visible=p>.01,o.body.material.opacity=p,o.glow.material.opacity=p*.95,o.glow.scale.setScalar(.18+p*.32),o.light.intensity=p*2.2,o.light.distance=1.8+p*2.2,o.trail.material.opacity=o.visibleStrength*.16;const m=o.trailPositions;for(let S=o.trailLength-1;S>0;S--)m[S*3+0]=m[(S-1)*3+0],m[S*3+1]=m[(S-1)*3+1],m[S*3+2]=m[(S-1)*3+2];m[0]=s.position.x,m[1]=s.position.y,m[2]=s.position.z,o.trail.geometry.attributes.position.needsUpdate=!0,s.visible=o.visibleStrength>.01}}function U_(i=.32){const t=[];for(let o=0;o<=48;o++){const a=o/48*Math.PI*2;t.push(new T(Math.cos(a)*i,0,Math.sin(a)*i))}const n=new ne().setFromPoints(t),r=new n_({color:16773800,dashSize:.08,gapSize:.045,transparent:!0,opacity:.95,depthWrite:!1}),s=new Ds(n,r);return s.computeLineDistances(),s}function Sc(){const i=new Xt(new gn(.09,18,18),new ke({color:10056791,roughness:.85,metalness:0}));return i.scale.set(.8,.55,1.05),i.castShadow=!0,i.receiveShadow=!0,i}function F_(){const i=new Qt,t=Sc();t.position.y=0;const e=U_(.34);e.rotation.x=-Math.PI/2,e.position.y=-.1,i.add(t),i.add(e),i.visible=!1;const n=new Qt,r=[],s={isPlacing:!1,canPlace:!1,previewPosition:new T,groundPosition:new T};function o(){s.isPlacing=!0,s.canPlace=!1,i.visible=!0,e.visible=!1}function a(){s.isPlacing=!1,s.canPlace=!1,i.visible=!1,e.visible=!1}function l(d){s.isPlacing&&(s.previewPosition.copy(d),i.position.copy(d),i.visible=!0)}function c(d){s.isPlacing&&(s.canPlace=!0,s.groundPosition.copy(d),e.visible=!0,e.position.set(d.x-i.position.x,d.y-i.position.y+.025,d.z-i.position.z))}function u(){s.isPlacing&&(s.canPlace=!1,e.visible=!1)}function h(){if(!s.isPlacing||!s.canPlace)return null;const d=Sc();return d.position.copy(s.previewPosition),d.rotation.set(Math.random()*.4,Math.random()*Math.PI*2,Math.random()*.4),n.add(d),r.push({mesh:d,velocity:new T(0,0,0),target:s.groundPosition.clone(),gravity:-7.5,bounce:.18,settled:!1}),a(),d}function f(d){const g=[];for(const _ of r){if(_.settled)continue;const p=_.mesh;_.velocity.y+=_.gravity*d,p.position.y+=_.velocity.y*d,p.position.x=tt.lerp(p.position.x,_.target.x,.12),p.position.z=tt.lerp(p.position.z,_.target.z,.12),p.rotation.x+=d*2.5,p.rotation.z+=d*1.6;const m=_.target.y+.08;p.position.y<=m&&(p.position.y=m,Math.abs(_.velocity.y)>1.2?_.velocity.y*=-_.bounce:(_.velocity.set(0,0,0),_.settled=!0,g.push({seed:p,position:_.target.clone()})))}return g}return{group:i,plantedSeeds:n,state:s,startPlacement:o,cancelPlacement:a,updatePreviewFloating:l,updateGroundTarget:c,clearGroundTarget:u,dropSeed:h,updateFallingSeeds:f}}function Nu(i){const t=new dt(i);return t.offsetHSL(0,-.05,-.25),t}const Qo=8;function O_({length:i=1.25,maxWidth:t=.34,lengthSegments:e=42,widthSegments:n=12}={}){const r=[],s=[],o=[],a=[];for(let u=0;u<=e;u++){const h=u/e,f=Math.sin(h*Math.PI)*(.82+.18*Math.sin(h*Math.PI)),d=t*f;for(let g=0;g<=n;g++){const p=g/n*2-1,m=p*d,S=h*i,M=Math.sin(h*Math.PI)*.045,w=Math.abs(p)*.06,L=Math.pow(h,1.8)*.065,R=M-w-L;r.push(m,S,R),o.push(h),a.push(p)}}const l=n+1;for(let u=0;u<e;u++)for(let h=0;h<n;h++){const f=u*l+h,d=f+1,g=f+l,_=g+1;s.push(f,g,d),s.push(d,g,_)}const c=new ne;return c.setAttribute("position",new Nt(r,3)),c.setAttribute("aHeightFactor",new Nt(o,1)),c.setAttribute("aSideFactor",new Nt(a,1)),c.setIndex(s),c.computeVertexNormals(),c}function ss(i={}){typeof i=="number"&&(i={color:i});const{color:t=4165439,length:e=1.25,maxWidth:n=.34,windStrength:r=.045,windSpeed:s=.9,interactionRadius:o=.42,interactionStrength:a=.28}=i,l=new Qt,c=O_({length:e,maxWidth:n}),u=new dt(t);u.offsetHSL((Math.random()-.5)*.025,(Math.random()-.5)*.08,(Math.random()-.5)*.07);const h=Nu(u),f=new Ge({side:Me,transparent:!1,uniforms:{uTime:{value:0},uBaseColor:{value:u},uNightColor:{value:h},uNightAmount:{value:0},uWindStrength:{value:r},uWindSpeed:{value:s},uWindPhase:{value:Math.random()*Math.PI*2},uCursorLocalPosition:{value:new T(999,999,999)},uCursorInfluence:{value:0},uInteractionRadius:{value:o},uInteractionStrength:{value:a},uFireflyPositions:{value:Array.from({length:Qo},()=>new T(999,999,999))},uFireflyCount:{value:0},uFireflyStrength:{value:.3},uFireflyRadius:{value:1.05},uFireflyColor:{value:new dt(16765802)},uRainAmount:{value:0},uWetness:{value:0},uRainTime:{value:0},uRainLightDir:{value:new T(.35,1,.25).normalize()},uLightningIntensity:{value:0}},vertexShader:`
      uniform float uTime;
    ...
    `}),r=new Xt(e,n);r.rotation.x=-Math.PI/2,r.position.y=t,r.renderOrder=3;const s={wetness:0,puddleAmount:0};function o(l,c){const u=c>.05?1:0,h=c>.45?1:0;s.wetness=tt.lerp(s.wetness,u,l*(c>.05?.9:.16)),s.puddleAmount=tt.lerp(s.puddleAmount,h,l*(c>.45?.35:.07)),n.uniforms.uTime.value+=l,n.uniforms.uWetness.value=s.wetness,n.uniforms.uPuddleAmount.value=s.puddleAmount}function a(){s.wetness=Math.min(1,s.wetness+.015),s.puddleAmount=Math.min(1,s.puddleAmount+.004)}return{mesh:r,material:n,state:s,update:o,addImpact:a}}function Ec(){const i=[],t=new T(tt.randFloatSpread(5),7,tt.randFloatSpread(3)-1),e=new T(t.x+tt.randFloatSpread(1.6),2.2,t.z+tt.randFloatSpread(1.2)),n=9;for(let s=0;s<=n;s++){const o=s/n,a=new T().lerpVectors(t,e,o),l=.28*(1-Math.abs(o-.5));a.x+=tt.randFloatSpread(l),a.z+=tt.randFloatSpread(l),i.push(a)}return new ne().setFromPoints(i)}function $_(){const i=new Qt,t=new Ea(13625087,0);t.position.set(-3,7,4),t.target.position.set(0,0,0),i.add(t),i.add(t.target);const e=new Sa(12573951,0,12,1.4);e.position.set(0,4.5,2),i.add(e);const n=new Mr({color:15398143,transparent:!0,opacity:0,blending:Ke,depthWrite:!1}),r=new Ds(Ec(),n);r.visible=!1,i.add(r);const s={intensity:0,targetIntensity:0,timer:0,nextStrike:tt.randFloat(4,9),strikeDuration:0,maxStrikeDuration:.16,isStriking:!1};function o(){r.geometry.dispose(),r.geometry=Ec(),r.visible=!0,s.isStriking=!0,s.strikeDuration=0,s.targetIntensity=1,t.position.set(tt.randFloat(-4,4),7,tt.randFloat(2,5)),e.position.copy(t.position)}function a(l,c=!1){if(!c)return s.timer=0,s.intensity=tt.lerp(s.intensity,0,.18),s.targetIntensity=0,t.intensity=s.intensity*0,e.intensity=s.intensity*0,r.material.opacity=0,r.visible=!1,s.intensity;if(s.timer+=l,!s.isStriking&&s.timer>s.nextStrike&&(o(),s.timer=0,s.nextStrike=tt.randFloat(3.5,8.5)),s.isStriking){s.strikeDuration+=l;const u=s.strikeDuration/s.maxStrikeDuration;let h;u<.25?h=1:u<.48?h=.15:u<.65?h=.8:h=1-Pe(.65,1,u),s.intensity=h,u>=1&&(s.isStriking=!1,s.targetIntensity=0,r.visible=!1)}else s.intensity=tt.lerp(s.intensity,0,.12);return t.intensity=s.intensity*7.5,e.intensity=s.intensity*5,r.material.opacity=s.intensity,r.visible=s.intensity>.03,s.intensity}return{group:i,flashLight:t,ambientFlash:e,bolt:r,state:s,update:a,triggerStrike:o}}const Q_=new T(0,-1,0),Co=new T(0,1,0),wc=new T,Tn=new T,Gn=new T,Po=new T,os=new T,Lo=new T,as=new T,bc=new $t;function Tc(){return new e_({color:14677759,transparent:!0,opacity:.72,roughness:.015,metalness:0,transmission:.75,thickness:.12,ior:1.333,clearcoat:1,clearcoatRoughness:.01,reflectivity:1,envMapIntensity:1.7,emissive:new dt(12574719),emissiveIntensity:.03,depthWrite:!1,depthTest:!0})}function tv(){const i=new gn(.018,12,8);return i.scale(.72,1.9,.72),i}function ev(){const i=new gn(.026,18,12);return i.scale(1,.32,1),i}function nv(){const i=document.createElement("canvas");i.width=48,i.height=48;const t=i.getContext("2d"),e=t.createRadialGradient(24,24,0,24,24,24);e.addColorStop(0,"rgba(255,255,255,1.0)"),e.addColorStop(.25,"rgba(220,245,255,0.75)"),e.addColorStop(1,"rgba(220,245,255,0.0)"),t.fillStyle=e,t.fillRect(0,0,48,48);const n=new da(i);return n.colorSpace=ye,n}function iv({count:i=90,groundRadius:t=4.75,spawnHeight:e=5.8,groundY:n=.02,windOffset:r=new Q(-.7,.08)}={}){const s=new Qt;s.visible=!1;const o=new Iu;o.far=e+1;const a=tv(),l=ev(),c=nv(),u=[],h=[],f=new Qt,d=new Qt;s.add(f),s.add(d);function g(){const y=Tc();y.opacity=.48,y.emissiveIntensity=.025;const v=new Xt(a,y);v.castShadow=!1,v.receiveShadow=!1;const D=new Yo(new Ms({map:c,color:16777215,transparent:!0,opacity:.35,depthWrite:!1,blending:Ke}));return D.scale.setScalar(.035),D.position.set(.006,.012,.006),v.add(D),v.userData={velocity:new T,life:1,highlight:D},v}function _(){const y=Tc();y.opacity=0,y.emissiveIntensity=.035;const v=new Xt(l,y);v.castShadow=!1,v.receiveShadow=!1,v.visible=!1;const D=new Yo(new Ms({map:c,color:16777215,transparent:!0,opacity:0,depthWrite:!1,blending:Ke}));return D.scale.setScalar(.045),D.position.set(.012,.012,.012),v.add(D),v.userData={attachedMesh:null,isAttached:!1,isFallingAfterDetach:!1,localPosition:new T,localNormal:new T(0,1,0),localVelocity:new T,worldVelocity:new T,normal:new T(0,1,0),life:0,maxLife:1,highlight:D},v}function p(y,v=!1){const D=Es(t);y.position.set(D.x,v?e+Math.random()*1.5:Math.random()*e,D.z),y.userData.velocity.set(r.x*(.35+Math.random()*.45),-(3.8+Math.random()*2.5),r.y*(.35+Math.random()*.45)),y.userData.life=1,y.visible=!0}function m(y,v,D=1){var Z;const F=h.find(et=>!et.visible);if(!F)return;const P=F.userData,k=y.object;F.visible=!0,P.attachedMesh=k,P.isAttached=!0,P.isFallingAfterDetach=!1,P.localPosition.copy(y.point),k.worldToLocal(P.localPosition),P.localNormal.copy(((Z=y.face)==null?void 0:Z.normal)||Co).normalize(),Gn.copy(P.localNormal).transformDirection(k.matrixWorld).normalize(),P.normal.copy(Gn),F.position.copy(P.localPosition),k.localToWorld(F.position),F.position.addScaledVector(Gn,.014),F.quaternion.setFromUnitVectors(Co,Gn);const X=.65+Math.random()*.85;F.scale.set(X*(.85+Math.random()*.35),X,X*(.85+Math.random()*.35)),P.localVelocity.set(0,-.025-Math.random()*.035,0),P.life=tt.lerp(1.1,2.8,D)+Math.random()*1.4,P.maxLife=P.life}for(let y=0;y<i;y++){const v=g();p(v),f.add(v),u.push(v)}for(let y=0;y<Math.floor(i*.8);y++){const v=_();d.add(v),h.push(v)}function S({drop:y,deltaTime:v,rainIntensity:D,lightningIntensity:F}){const P=y.userData,k=P.attachedMesh;if(!k){P.isAttached=!1;return}if(os.set(0,-1,0),bc.copy(k.matrixWorld).invert(),os.transformDirection(bc).normalize(),Lo.copy(P.localNormal).normalize(),as.copy(os).addScaledVector(Lo,-os.dot(Lo)),as.lengthSq()>1e-4){as.normalize();const Z=tt.lerp(.025,.12,D);P.localVelocity.addScaledVector(as,Z*v)}P.localVelocity.multiplyScalar(.985),P.localPosition.addScaledVector(P.localVelocity,v),y.position.copy(P.localPosition),k.localToWorld(y.position),Gn.copy(P.localNormal).transformDirection(k.matrixWorld).normalize(),y.position.addScaledVector(Gn,.014),y.quaternion.setFromUnitVectors(Co,Gn),(P.localPosition.y<-.06||P.localPosition.y>1.5||Math.abs(P.localPosition.x)>.5||P.life<=.15)&&M(y),P.isAttached&&k.userData&&(k.userData.wetness=Math.min(1,(k.userData.wetness||0)+D*v*.08)),L({drop:y,rainIntensity:D,lightningIntensity:F})}function M(y){const v=y.userData;v.isAttached=!1,v.attachedMesh=null,v.isFallingAfterDetach=!0,v.worldVelocity.set(v.localVelocity.x*.45,-.55-Math.random()*.45,v.localVelocity.z*.45)}function w({drop:y,deltaTime:v,rainIntensity:D,lightningIntensity:F}){const P=y.userData;P.worldVelocity.y-=1.8*v,y.position.addScaledVector(P.worldVelocity,v),L({drop:y,rainIntensity:D,lightningIntensity:F}),y.position.y<=n&&R(y)}function L({drop:y,rainIntensity:v,lightningIntensity:D}){const F=y.userData,P=1-F.life/F.maxLife,k=tt.clamp(1-P,0,1);y.material.opacity=k*tt.lerp(.38,.82,v),y.material.emissiveIntensity=.035+D*.7,y.material.envMapIntensity=1.5+v*1.4+D*2.6,F.highlight&&(F.highlight.material.opacity=k*(.22+v*.3+D*.85));const X=tt.lerp(1,.55,P);y.scale.x=tt.lerp(y.scale.x,X,.015),y.scale.z=tt.lerp(y.scale.z,X,.015)}function R(y){const v=y.userData;y.visible=!1,v.attachedMesh=null,v.isAttached=!1,v.isFallingAfterDetach=!1,v.life=0,v.localVelocity.set(0,0,0),v.worldVelocity.set(0,0,0),v.highlight&&(v.highlight.material.opacity=0)}function A({deltaTime:y,stormState:v,collisionMeshes:D=[],lightningIntensity:F=0}){const P=(v==null?void 0:v.rainIntensity)??0,k=(v==null?void 0:v.windStrength)??0;if(s.visible=P>.02,P<=.02)return;const X=(v==null?void 0:v.windDirection)||new Q(-.75,.1),Z=X.x*k*.55,et=X.y*k*.55;for(const z of u){const K=z.userData.velocity;Po.copy(z.position),K.x+=Z*y,K.z+=et*y,z.position.addScaledVector(K,y*tt.lerp(.45,1,P)),Tn.copy(K),Tn.lengthSq()>1e-4&&(Tn.normalize(),z.quaternion.setFromUnitVectors(Q_,Tn)),wc.copy(Po),Tn.subVectors(z.position,Po);const nt=Tn.length();if(nt>1e-4&&D.length>0){Tn.normalize(),o.set(wc,Tn),o.far=nt+.04;const Gt=o.intersectObjects(D,!1);if(Gt.length>0){m(Gt[0],K,P),p(z,!0);continue}}z.position.y<=n&&p(z,!0),z.position.x*z.position.x+z.position.z*z.position.z>t*t&&p(z,!0);const It=F*.75;z.material.opacity=tt.lerp(.26,.62,P)+It*.25,z.material.emissiveIntensity=.025+F*.55,z.material.envMapIntensity=1.3+P*1.2+F*2.2,z.userData.highlight&&(z.userData.highlight.material.opacity=.18+P*.26+F*.7)}for(const z of h){if(!z.visible)continue;const K=z.userData;K.life-=y,K.isAttached?S({drop:z,deltaTime:y,rainIntensity:P,lightningIntensity:F}):K.isFallingAfterDetach&&w({drop:z,deltaTime:y,rainIntensity:P,lightningIntensity:F}),K.life<=0&&R(z)}}function U(y){s.visible=y}return{group:s,fallingDrops:u,surfaceDrops:h,update:A,setActive:U}}const Wn=new T,Kn=new T,ls=new T,cs=new T,Fu=new dt(3482903),rv=new dt(1777970),sv=new dt(328707);new dt(0);const ws=new dt(16777215),Ac=new dt(3432731288);function bs(i=3.8){const t=Math.sqrt(Math.random())*i,e=Math.random()*Math.PI*2;return new T(Math.cos(e)*t,1.1+Math.random()*1.8,Math.sin(e)*t)}function ov(i){i.computeBoundingBox();const t=i.boundingBox,e=t.max.x-t.min.x,n=t.max.z-t.min.z,r=i.attributes.position,s=[];for(let o=0;o<r.count;o++){const a=r.getX(o),l=r.getZ(o),c=e>0?(a-t.min.x)/e:0,u=n>0?(l-t.min.z)/n:0;s.push(c,u)}i.setAttribute("uv",new Nt(s,2))}function Rc(i=1){const t=new Au;t.moveTo(0,-.22),t.bezierCurveTo(i*.12,-.46,i*.46,-.66,i*.78,-.42),t.bezierCurveTo(i*.96,-.27,i*.88,-.02,i*.56,.02),t.bezierCurveTo(i*.66,.1,i*.64,.18,i*.5,.2),t.bezierCurveTo(i*.68,.34,i*.5,.55,i*.25,.42),t.bezierCurveTo(i*.08,.34,i*.02,.15,0,.08),t.lineTo(0,-.22);const e=new xa(t,80),n=e.attributes.position;for(let r=0;r<n.count;r++){const s=n.getX(r),o=n.getY(r),a=Math.abs(s),l=Math.sin(tt.clamp(a/.85,0,1)*Math.PI)*.025,c=Math.sin((o+.25)*Math.PI*2.4)*a*.01;n.setXYZ(r,s,l+c,o)}return ov(e),e.computeVertexNormals(),e}function Cc(i=1,t){const e=new Is([new T(i*.022,.03,-.13),new T(i*.055,.08,-.18),new T(i*.075,.12,-.23),new T(i*.055,.145,-.27)]),n=new Sr(e,16,.004,5,!1),r=new Xt(n,t),s=new Xt(new gn(.009,8,6),t);return s.position.copy(e.getPoint(1)),r.add(s),r}function Ri(i=1,t=0,e){const n=new Is([new T(i*.018,-.012,t),new T(i*.055,-.035,t+.015),new T(i*.095,-.055,t+.04)]),r=new Sr(n,8,.003,4,!1);return new Xt(r,e)}function av(){const i=new Qt,t=new Lu,e=t.load("/textures/wings-monarch.jpg");e.colorSpace=ye;const n=t.load("/textures/wings-monarch.jpg");n.colorSpace=ye,n.wrapS=Oi,n.repeat.x=-1;const r=new ke({color:Fu,roughness:.8,metalness:0}),s=new ke({color:sv,roughness:.35,metalness:.05}),o=new ke({map:n,color:ws,roughness:.62,metalness:0,side:Me}),a=new ke({map:e,color:ws,roughness:.62,metalness:0,side:Me});i.userData.materials={bodyMaterial:r,eyeMaterial:s,leftWingMaterial:o,rightWingMaterial:a,nightMix:0};const l=new Xt(new _a(.028,.19,8,14),r);l.rotation.x=Math.PI/2,l.position.set(0,-.002,.07),l.scale.set(.82,1.5,1.22),i.add(l);const c=new Xt(new gn(.038,14,10),r);c.position.set(0,.012,-.125),c.scale.set(1,.92,1.08),i.add(c);const u=new Qt,h=new Qt;u.position.set(-.018,.012,-.035),h.position.set(.018,.012,-.035),i.add(u),i.add(h);const f=new Qt,d=new Qt,g=new Xt(Rc(-1),o),_=new Xt(Rc(1),a);return f.add(g),d.add(_),f.rotation.z=tt.degToRad(-4),d.rotation.z=tt.degToRad(4),f.rotation.x=tt.degToRad(2),d.rotation.x=tt.degToRad(2),u.add(f),h.add(d),i.add(Cc(-1,r)),i.add(Cc(1,r)),i.add(Ri(-1,-.085,r)),i.add(Ri(1,-.085,r)),i.add(Ri(-1,-.03,r)),i.add(Ri(1,-.03,r)),i.add(Ri(-1,.035,r)),i.add(Ri(1,.035,r)),i.userData.leftWingPivot=u,i.userData.rightWingPivot=h,i.scale.setScalar(.5),i.traverse(p=>{p.isMesh&&(p.castShadow=!0,p.receiveShadow=!0)}),i}function lv({position:i,direction:t,plants:e}){ls.set(0,0,0);for(const n of e){n.getWorldPosition(Kn),Kn.y+=.8;const r=.45,s=i.distanceTo(Kn);if(s<r&&(cs.subVectors(i,Kn),cs.lengthSq()>1e-4)){cs.normalize();const o=1-s/r;ls.addScaledVector(cs,o*o*.9)}}ls.lengthSq()>1e-4&&t.add(ls).normalize()}function Pc({radius:i,plants:t}){for(let e=0;e<18;e++){const n=bs(i);for(const r of t){if(r.getWorldPosition(Kn),Kn.y+=.85,n.distanceTo(Kn)<.75)break;return n}}return bs(i)}function cv({radius:i=3.8}={}){const t=new Qt,e=av();t.add(e),e.position.copy(bs(i));const n={radius:i,target:bs(i),speed:.55,turnSpeed:4.5,flapPhase:Math.random()*Math.PI*2,flapSpeed:12,hoverPhase:Math.random()*Math.PI*2,visibleStrength:1};return t.userData={butterfly:e,state:n},{group:t,butterfly:e,state:n}}function uv(i,t,e,{isNight:n=!1,plants:r=[],isRaining:s=!1}={}){const{butterfly:o,state:a}=i,l=o.userData.materials;if(l){const _=tt.lerp(l.nightMix||0,n?1:0,t*3);l.nightMix=_,l.bodyMaterial.color.lerpColors(Fu,rv,_),l.leftWingMaterial.color.lerpColors(ws,Ac,_),l.rightWingMaterial.color.lerpColors(ws,Ac,_),l.leftWingMaterial.emissive.set(659496),l.rightWingMaterial.emissive.set(659496),l.leftWingMaterial.emissiveIntensity=.06*_,l.rightWingMaterial.emissiveIntensity=.06*_}const c=s?0:1;if(a.visibleStrength=tt.lerp(a.visibleStrength,c,t*4),o.visible=a.visibleStrength>.03,!o.visible)return;o.scale.setScalar(.65*a.visibleStrength);const u=Math.sin(e*a.flapSpeed+a.flapPhase)*.75,h=o.userData.leftWingPivot,f=o.userData.rightWingPivot;if(h&&f&&(h.rotation.z=tt.degToRad(-6)-u,f.rotation.z=tt.degToRad(6)+u),o.position.distanceTo(a.target)<.22&&a.target.copy(Pc({radius:a.radius,plants:r})),Wn.subVectors(a.target,o.position),Wn.length()>.001){Wn.normalize(),lv({position:o.position,direction:Wn,plants:r});const _=a.speed*(.82+.18*Math.sin(e*2.3+a.hoverPhase));o.position.addScaledVector(Wn,_*t),o.position.y+=Math.sin(e*4+a.hoverPhase)*.006,o.position.y=tt.clamp(o.position.y,.7,3.5),Math.sqrt(o.position.x*o.position.x+o.position.z*o.position.z)>a.radius*1.05&&a.target.copy(Pc({radius:a.radius*.75,plants:r}));let S=Math.atan2(-Wn.x,-Wn.z)-o.rotation.y;S=Math.atan2(Math.sin(S),Math.cos(S)),o.rotation.y+=S*Math.min(1,t*a.turnSpeed),o.rotation.z=-S*.45}}const Ou=document.querySelector("#webgl"),{scene:ge,ambientLight:Lc}=d_(),{groundGroup:hv,topSurface:fv}=x_(5);ge.add(hv);const na=y_({radius:4.75,bladeCount:16e3});ge.add(na);const zu=w_();ge.add(zu.group);const Bu=T_({count:420});ge.add(Bu);const Hu=J_({radius:4.75,y:.024});ge.add(Hu.mesh);const le=q_(),wa=K_({count:1200,radius:4.75,height:7});ge.add(wa.group);const ba=iv({count:200,groundRadius:4.75,spawnHeight:6.2,groundY:.03,windOffset:new Q(-.75,.08)});ge.add(ba.group);const Vu=$_();ge.add(Vu.group);const Ta=new Ea(12574719,.15);Ta.position.set(-3,5.5,2);ge.add(Ta);const Aa=new Sa(14544639,0,12,1.6);Aa.position.set(-2.8,4.8,1.6);ge.add(Aa);const us=new Iu,ia=new Q,hs=new T(999,999,999),Do=new T(999,999,999),dv=new dn(new T(0,1,0),-1.6),Dc=new T,Le=F_();ge.add(Le.group);ge.add(Le.plantedSeeds);const ku=new Qt;ge.add(ku);const Io=[],Ci=[],ar=cv({radius:4});ge.add(ar.group);const Ts=I_({count:25,trailLength:14});ge.add(Ts.group);const Gu=8,No=Array.from({length:Gu},()=>new T(999,999,999)),Uo=new T,Ic=new T;let pn=!1;function pv(i){if(!pn)return[];const t=Ts.lights||Ts.group.userData.lights||[];if(t.length===0)return[];i.getWorldPosition(Uo),Uo.y+=1;const e=t.map(n=>(n.getWorldPosition(Ic),{light:n,distance:Ic.distanceToSquared(Uo)})).sort((n,r)=>n.distance-r.distance);for(let n=0;n<Gu;n++)e[n]?e[n].light.getWorldPosition(No[n]):No[n].set(999,999,999);return No}const Fo=document.querySelector("#nightToggle");Fo&&Fo.addEventListener("change",()=>{pn=Fo.checked,b_(zu,pn),ge.background=new dt(pn?463135:8900331)});const Jn=document.querySelector("#seedButton"),In=document.querySelector("#flowerColorPicker"),Nc=document.querySelector("#resetFlowerColorButton"),Uc=document.querySelector("#confirmFlowerColorButton"),Fc=document.querySelector("#cancelFlowerColorButton"),Hi=document.querySelector("#flowerColorMenu"),Ra="#f2a0c4";let Er=15900868;Jn&&Jn.addEventListener("click",()=>{Hi&&Hi.classList.remove("hidden"),In&&(In.value=Ra),Er=15900868,Jn.classList.add("active")});Nc&&Nc.addEventListener("click",()=>{In&&(In.value=Ra),Er=15900868});Uc&&Uc.addEventListener("click",()=>{Er=In?Number(In.value.replace("#","0x")):15900868,Hi&&Hi.classList.add("hidden"),Le.startPlacement()});Fc&&Fc.addEventListener("click",()=>{Hi&&Hi.classList.add("hidden"),In&&(In.value=Ra),Er=DEFAULT_FLOWER_COLOR,Jn&&Jn.classList.remove("active"),Le.state.isPlacing&&(Le.clearGroundTarget(),Le.state.isPlacing=!1)});const fs=document.querySelector("#stormButton");fs&&fs.addEventListener("click",()=>{le.toggle(),wa.setActive(le.state.enabled),ba.setActive(le.state.enabled),fs.classList.toggle("active",le.state.enabled),fs.textContent=le.state.enabled?"Stop Storm":"Start Storm"});const $e={width:window.innerWidth,height:window.innerHeight},xe=new Oe(45,$e.width/$e.height,.1,100);xe.position.set(0,5.5,8);ge.add(xe);let $n=!1;const ra=new T,sa=new T,mv=new T(0,0,-.16),gv=new T(0,-.5,-.9),Oc=new T,zc=new T,nn=new yg({canvas:Ou,antialias:!0});nn.setSize($e.width,$e.height);nn.setPixelRatio(Math.min(window.devicePixelRatio,2));nn.shadowMap.enabled=!0;nn.shadowMap.type=Gc;nn.outputColorSpace=ye;nn.toneMapping=Xc;nn.toneMappingExposure=1.05;const Se=new f_(xe,Ou);Se.enableDamping=!0;Se.dampingFactor=.06;Se.target.set(0,.3,0);Se.maxPolarAngle=Math.PI*.48;Se.enableZoom=!0;Se.minDistance=2.2;Se.maxDistance=14;Se.zoomSpeed=.8;window.addEventListener("resize",()=>{$e.width=window.innerWidth,$e.height=window.innerHeight,xe.aspect=$e.width/$e.height,xe.updateProjectionMatrix(),nn.setSize($e.width,$e.height),nn.setPixelRatio(Math.min(window.devicePixelRatio,2))});window.addEventListener("mousemove",i=>{ia.x=i.clientX/window.innerWidth*2-1,ia.y=-(i.clientY/window.innerHeight)*2+1});window.addEventListener("click",i=>{if(!Le.state.isPlacing||i.target.closest("#ui"))return;Le.dropSeed()&&Jn&&Jn.classList.remove("active")});window.addEventListener("keydown",i=>{i.key.toLowerCase()==="s"&&($n=!$n,$n?(ra.copy(xe.position),sa.copy(Se.target),xe.fov=45,xe.updateProjectionMatrix(),Se.enabled=!1):(xe.position.copy(ra),Se.target.copy(sa),xe.fov=45,xe.updateProjectionMatrix(),Se.enabled=!0,Se.update()),Ca(le.state.enabled&&le.state.rainIntensity>.05))});const Oo=document.querySelector("#growthControls"),Bc=document.querySelector("#growthSpeedSlider"),Hc=document.querySelector("#growthSpeedValue"),zo=document.querySelector("#switchModeHint");let oa=1;Bc&&Bc.addEventListener("input",i=>{oa=Number(i.target.value),Hc&&(Hc.textContent=`${oa.toFixed(1)}x`)});function Ca(i){if(!zo)return;zo.classList.toggle("hidden",i);const t=zo.querySelector("h4");t&&(t.textContent=$n?"Press S to exit butterfly view":"Press S to enter butterfly view")}function _v(i){if(!$n)return;const t=ar==null?void 0:ar.butterfly,e=le.state.enabled&&le.state.rainIntensity>.05;if(e){$n=!1,xe.position.copy(ra),Se.target.copy(sa),xe.fov=45,xe.updateProjectionMatrix(),Se.enabled=!0,Se.update(),Ca(e);return}!t||!t.visible||(Oc.copy(mv).applyQuaternion(t.quaternion).add(t.position),zc.copy(gv).applyQuaternion(t.quaternion).add(t.position),xe.position.lerp(Oc,1-Math.exp(-i*8)),xe.lookAt(zc))}const Vc=new u_;function Wu(){var f,d,g;const i=Vc.getDelta(),t=Vc.getElapsedTime();le.update(i,t);const e=.28,n=.45;na.material.uniforms.uWindStrength.value=tt.lerp(e,n,le.state.rainIntensity);const r=le.state.enabled&&le.state.rainIntensity>.05;Ca(r);const s=Vu.update(i,r);if(!pn){const _=new dt(8900331),p=new dt(6255746);ge.background=_.lerp(p,le.state.skyDarkness*.75)}if(Lc&&(Lc.intensity=tt.lerp(1,.45,le.state.skyDarkness)+s*.65),Ta.intensity=tt.lerp(.15,.65,le.state.rainIntensity)+s*1.2,Aa.intensity=s*4.5,us.setFromCamera(ia,xe),Do.set(999,999,999),Ci.length>0){const _=us.intersectObjects(Ci,!1);_.length>0&&Do.copy(_[0].point)}Le.state.isPlacing&&(us.ray.intersectPlane(dv,Dc),Le.updatePreviewFloating(Dc));const o=us.intersectObject(fv);o.length>0?(hs.copy(o[0].point),Le.state.isPlacing&&Le.updateGroundTarget(hs)):(hs.set(999,999,999),Le.state.isPlacing&&Le.clearGroundTarget()),wa.update(i,t,le.state),ba.update({deltaTime:i,stormState:le.state,collisionMeshes:Ci,lightningIntensity:s}),Hu.update(i,le.state.rainIntensity),S_(na,t,hs),A_(Bu,t,pn),N_(Ts,t,pn,Ci);const a=Le.updateFallingSeeds(i);for(const _ of a){const p=X_(_.position,{flowerColor:Er});Io.push(p),ku.add(p);for(const m of p.userData.leaves)m.userData.leafMesh&&Ci.push(m.userData.leafMesh);if(p.userData.flower&&p.userData.flower.userData&&p.userData.flower.userData.petals)for(const m of p.userData.flower.userData.petals)Ci.push(m)}let l=!1;const c=le.state.enabled?1:0,u=.045,h=.25;for(const _ of Io){const p=tt.lerp(u,h,le.state.rainIntensity);for(const M of _.userData.leaves)(g=(d=(f=M.userData)==null?void 0:f.material)==null?void 0:d.uniforms)!=null&&g.uWindStrength&&(M.userData.material.uniforms.uWindStrength.value=p);const m=pv(_);Y_(_,i,t,oa,Do,m,le.state.rainIntensity,s,c,pn)&&(l=!0)}uv(ar,i,t,{isNight:pn,plants:Io,isRaining:r}),Oo&&(l?Oo.classList.remove("hidden"):Oo.classList.add("hidden")),$n?_v(i):Se.update(),nn.render(ge,xe),requestAnimationFrame(Wu)}Wu();
